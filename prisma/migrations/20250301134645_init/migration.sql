...
-- AlterTable
ALTER TABLE `CategoryGroup` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `createdBy` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `deleted` TINYINT NOT NULL DEFAULT 0,
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedBy` INTEGER NOT NULL DEFAULT 0;
...
-- AlterTable
ALTER TABLE `Thread` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `createdBy` INTEGER NOT NULL DEFAULT 0,
    ADD COLUMN `deleted` TINYINT NOT NULL DEFAULT 0,
    ADD COLUMN `updatedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ADD COLUMN `updatedBy` INTEGER NOT NULL DEFAULT 0;
